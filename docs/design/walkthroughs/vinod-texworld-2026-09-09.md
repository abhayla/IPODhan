# Walkthrough: Vinod Texworld Limited (VINOD) — 2026-09-09
...
- **239 of 240 fields apply** to a SME_NSE issue; 1 are N/A for this offering type.
...
- **188 applicable fields are empty on production right now.** That is the number the pull model exists to move.
...
`R1` is the source the plan would ask first for a SME_NSE issue. "What the rank-1 source says"
...
|---|---|---|---|---|---|---|---|
| `ipos.symbol` | D | DOC | NSE · CG | _(searched, no matching label)_ | `VINOD` | _(no rule stated)_ | — |
...
| `ipos.lot_size` | D | DOC | NSE · CG | lot_size = 107 | `1200` | pass | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipos.open_date` | T | NSE | CG · — | _(searched, no matching label)_ | 2026-09-08 | pass | — |
| `ipos.close_date` | T | NSE | CG · — | _(searched, no matching label)_ | 2026-09-10 | pass | — |
| `ipos.listing_date` | T | NSE | CG · — | _(searched, no matching label)_ | 2026-09-16 | pass | — |
| `ipos.status` | T | NSE | CG · — | status = Active | `OPEN` | _(no rule stated)_ | `nse/ipo-current-issue.json` |
...
| `ipos.slug` | C | — | — · — | _(searched, no matching label)_ | `vinod-texworld-ltd` | _(no rule stated)_ | — |
| `ipos.sector` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipos.price_range_min` | D | DOC | NSE · CG | price_band_floor = 132 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipos.price_range_max` | D | DOC | NSE · CG | price_band_cap = 139 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipos.face_value` | D | DOC | NSE · CG | face_value = 10 | `10` | pass | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
...
| `ipos.lead_managers` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipos.isin` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipos.segment` | D | DOC | NSE · CG | _(searched, no matching label)_ | `SME` | _(no rule stated)_ | — |
| `ipos.offering_type` | D | DOC | CG · — | _(searched, no matching label)_ | `IPO` | _(no rule stated)_ | — |
...
| `ipos.company_website` | D | DOC | CG · — | _(searched, no matching label)_ | `https://www.ftfinsec.com` | _(no rule stated)_ | — |
| `ipos.verifier_url` | I | — | — · — | _(searched, no matching label)_ | `https://www.chittorgarh.com/ipo/vinod-texworld-ipo/2718/` | _(no rule stated)_ | — |
| `ipos.cin` | D | DOC | — · — | cin = U65999MH2002PLC134884 | `U17200GJ2012PLC071210` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `ipo_details.company_description` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.issue_type` | D | DOC | NSE · CG | issue_price_type = BOOK_BUILDING | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-RHP.json` |
| `ipo_details.fresh_issue` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.ofs_issue` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.face_value` | D | DOC | CG · — | face_value = 10 | `10.00` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `ipo_details.basis_of_allotment_date` | T | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.initiation_of_refunds_date` | T | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.credit_of_shares_date` | T | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.exchanges` | D | DOC | NSE · CG | designated_stock_exchange = NSE | `["NSE","BSE"]` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipo_details.compliance_officer` | D | DOC | — · — | compliance_officer = Ameet Ashok Kela | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.compliance_officer_phone` | D | DOC | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.compliance_officer_email` | D | DOC | — · — | compliance_officer_email = cs@arcil.co.in | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.upi_cutoff_time` | D | DOC | NSE · CG | upi_cutoff_time = 17:00 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.designated_exchange` | D | DOC | — · — | designated_stock_exchange = NSE | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.lot_multiple` | D | DOC | CG · — | lot_multiple = 107 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.allocation_pct` | D | DOC | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.pre_ipo_placement` | D | DOC | — · — | pre_ipo_placement = false | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_details.bid_windows` | D | DOC | NSE · CG | bid_windows = [6] | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipo_details.isin` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.registrar_link` | D | DOC | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.lead_managers` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `ipo_details.sponsor_banks` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.tick_size` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_details.ipo_market_timings` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `financial_data.revenue_fy2023` | D | DOC | CG · — | _(searched, no matching label)_ | `200.67` | _(no rule stated)_ | — |
| `financial_data.revenue_fy2024` | D | DOC | CG · — | _(searched, no matching label)_ | `271.49` | _(no rule stated)_ | — |
| `financial_data.profit_fy2022` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `financial_data.profit_fy2023` | D | DOC | CG · — | _(searched, no matching label)_ | `0.68` | _(no rule stated)_ | — |
| `financial_data.profit_fy2024` | D | DOC | CG · — | _(searched, no matching label)_ | `5.30` | _(no rule stated)_ | — |
| `financial_data.net_worth` | D | DOC | CG · — | net_worth_by_fy = {"2023":22397.43,"2024":24625.11,"2025":2767 | `31.98` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_data.eps` | D | DOC | CG · — | eps_basic_by_fy = {"2024":10.17,"2025":10.14,"2026":10.82} | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `financial_data.ebitda_fy2023` | D | DOC | CG · — | _(searched, no matching label)_ | `4.80` | _(no rule stated)_ | — |
| `financial_data.ebitda_fy2024` | D | DOC | CG · — | _(searched, no matching label)_ | `12.29` | _(no rule stated)_ | — |
...
| `financial_data.total_income_fy2024` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `financial_statements.fiscal_year` | D | DOC | CG · — | fiscal_years = [3] | `2023` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.revenue` | D | DOC | CG · — | revenue_by_fy = {"2023":7513.14,"2024":5701.41,"2025":5964.2 | `20066.90` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.total_income` | D | DOC | CG · — | total_income_by_fy = {"2023":7537.11,"2024":5741.06,"2025":6233.9 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.ebitda` | D | DOC | CG · — | ebitda_by_fy = {"2023":3727.26,"2024":4423.89,"2025":4649.1 | `480.24` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.pat` | D | DOC | CG · — | pat_by_fy = {"2023":2391.24,"2024":3053.41,"2025":3553.1 | `67.65` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.net_worth` | D | DOC | CG · — | net_worth_by_fy = {"2023":22397.43,"2024":24625.11,"2025":2767 | `1647.56` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
...
| `financial_statements.unit` | D | DOC | CG · — | unit = millions | `LAKH` | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `financial_statements.eps_basic` | D | DOC | — · — | eps_basic_by_fy = {"2024":10.17,"2025":10.14,"2026":10.82} | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `financial_statements.eps_diluted` | D | DOC | — · — | eps_diluted_by_fy = {"2024":10.17,"2025":10.14,"2026":10.82} | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipo_valuation.price_floor` | D | DOC | NSE · CG | price_band_floor = 132 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_valuation.price_cap` | D | DOC | NSE · CG | price_band_cap = 139 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_valuation.mcap_at_cap` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_valuation.pe_at_cap` | D | DOC | CG · — | pe_at_cap = 12.85 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_valuation.mcap_at_floor` | D | DOC | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_valuation.pe_at_floor` | D | DOC | — · — | pe_at_floor = 12.2 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipo_valuation.ofs_shares` | D | DOC | — · — | ofs_shares = 52731946 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `promoters.name` | D | DOC | CG · — | promoter_name = Avenue India Resurgence Pte. Ltd | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
...
| `ipo_intermediaries.role` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_intermediaries.name` | D | DOC | CG · — | promoter_name = Avenue India Resurgence Pte. Ltd | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-PRICE_BAND_AD.json` |
| `ipo_risk_factors.seq` | D | DOC | — · — | _(searched, no matching label)_ | `1` | _(no rule stated)_ | — |
| `ipo_risk_factors.heading` | D | DOC | — · — | _(searched, no matching label)_ | `Our top ten customers contribute Major portion in the rev...` | _(no rule stated)_ | — |
...
| `anchor_investors.bid_date` | T | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `documents.filing_date` | D | DOC | — · — | rhp_filing_date = 2025-08-01 | _(empty)_ | _(no rule stated)_ | `extraction/asset-reconstruction-company-india-ltd-DRHP.json` |
| `subscriptions.timestamp` | I | — | — · — | _(searched, no matching label)_ | 2026-09-08 | _(no rule stated)_ | — |
| `subscriptions.qib_subscription` | X | NSE | CG · — | _(searched, no matching label)_ | `0.00` | _(no rule stated)_ | — |
| `subscriptions.nii_subscription` | X | NSE | CG · — | _(searched, no matching label)_ | `0.00` | _(no rule stated)_ | — |
| `subscriptions.retail_subscription` | X | NSE | CG · — | Maximum Subscription Amount for Retail Investor = "Rs. 2,00,000" | `0.00` | _(no rule stated)_ | `nse/ipo-detail-ARCIL.json` |
| `subscriptions.total_subscription` | X | NSE | CG · — | _(searched, no matching label)_ | `0.01` | _(no rule stated)_ | — |
| `subscriptions.employee_subscription` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `subscriptions.b_nii_subscription` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `subscriptions.s_nii_subscription` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `subscriptions.total_shares_bid` | X | NSE | — · — | _(searched, no matching label)_ | `31200` | _(no rule stated)_ | — |
| `subscriptions.shares_offered` | X | NSE | — · — | _(searched, no matching label)_ | `4556400` | _(no rule stated)_ | — |
| `subscriptions.scope` | I | — | — · — | _(searched, no matching label)_ | `NSE_ONLY` | _(no rule stated)_ | — |
| `gmp_records.timestamp` | I | — | — · — | _(searched, no matching label)_ | 2026-09-08 | _(no rule stated)_ | — |
| `gmp_records.gmp` | W | IG | CG · — | GMP = &#8377;<b>248</b> (-%)<br><small style="font | `8.00` | _(no rule stated)_ | `investorgain/gmp-live.json` |
| `gmp_records.source` | I | — | — · — | _(searched, no matching label)_ | `INVESTORGAIN_GMP` | _(no rule stated)_ | — |
| `gmp_records.gmp_percentage` | C | — | — · — | _(searched, no matching label)_ | `8.51` | _(no rule stated)_ | — |
| `listing_performance.listing_price` | M | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `listing_performance.current_price` | M | NSE | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `ipo_demand_graph.price_point` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_demand_graph.is_cut_off` | X | NSE | — · — | Cut-off time for UPI Mandate Confirmation = "11-Sep-2026 (upto 5:00 PM) The new cut-off  | _(empty)_ | _(no rule stated)_ | `nse/ipo-detail-ARCIL.json` |
| `ipo_demand_graph.cumulative_quantity` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_demand_graph.exchange` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
_Regenerate: `node docs/design/probes/walkthrough.mjs vinod-texworld-ltd`._
