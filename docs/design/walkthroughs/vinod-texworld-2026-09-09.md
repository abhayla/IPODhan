...
| `ipos.cin` | D | DOC | — · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | `U17200GJ2012PLC071210` | _(no rule stated)_ | — |
...
| `ipo_details.face_value` | D | DOC | CG · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | `10.00` | _(no rule stated)_ | — |
...
| `ipo_details.exchanges` | D | DOC | NSE · CG | _(searched, no matching label)_ | `["NSE","BSE"]` | _(no rule stated)_ | — |
...
| `ipo_details.lot_multiple` | D | DOC | CG · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `financial_data.net_worth` | D | DOC | CG · — | _(searched, no matching label)_ | `31.98` | _(no rule stated)_ | — |
...
| `financial_statements.revenue` | D | DOC | CG · — | _(searched, no matching label)_ | `20066.90` | _(no rule stated)_ | — |
| `financial_statements.total_income` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `financial_statements.ebitda` | D | DOC | CG · — | _(searched, no matching label)_ | `480.24` | _(no rule stated)_ | — |
| `financial_statements.pat` | D | DOC | CG · — | _(searched, no matching label)_ | `67.65` | _(no rule stated)_ | — |
| `financial_statements.net_worth` | D | DOC | CG · — | _(searched, no matching label)_ | `1647.56` | _(no rule stated)_ | — |
...
| `ipo_valuation.price_floor` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
| `ipo_valuation.price_cap` | D | DOC | NSE · CG | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `ipo_intermediaries.name` | D | DOC | CG · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `documents.filing_date` | D | DOC | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
...
| `subscriptions.retail_subscription` | X | NSE | CG · — | _(searched, no matching label)_ | `0.00` | _(no rule stated)_ | — |
| `subscriptions.total_subscription` | X | NSE | CG · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | `0.01` | _(no rule stated)_ | — |
...
| `subscriptions.total_shares_bid` | X | NSE | — · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | `31200` | _(no rule stated)_ | — |
| `subscriptions.shares_offered` | X | NSE | — · — | _(the source carries this field, but the only saved payload proving it belongs to a DIFFERENT IPO — nothing quoted)_ | `4556400` | _(no rule stated)_ | — |
...
| `gmp_records.gmp` | W | IG | CG · — | GMP | `8.00` | _(no rule stated)_ | `investorgain/gmp-live.json` |
...
| `ipo_demand_graph.is_cut_off` | X | NSE | — · — | _(searched, no matching label)_ | _(empty)_ | _(no rule stated)_ | — |
