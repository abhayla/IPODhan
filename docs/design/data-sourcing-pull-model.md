...
2. Not already marked done, and not marked failed **or partial** with the **same cause class** as last time, unless the source rankings changed since (OD-78). Never-walked IPOs come first.
