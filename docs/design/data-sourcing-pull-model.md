...
1. An anchor investors' bid date sits inside a list OD-107 makes admin-owned, while OD-106 lets the
   exchange replace an admin date; and OD-106's "newer date" does not say what "newer" means for
   `listing_exchanges`, which is not a date.
