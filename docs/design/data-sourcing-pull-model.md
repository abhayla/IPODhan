...
| 2 | **The SEBI draft filing number** | the day the draft is filed | it identifies the OFFERING, not the company, which is exactly what the one-row rule is about (note F-125) |
...
number" names an identifier that does not exist in that form. Open for owner decision; not changed
here — see the identity-research subsection at the end of this section.
