...
| `docs/reviews/detection-checks/document-download-refusals.json` | NEW | See Detection. |
...
**NEW check**, `docs/reviews/detection-checks/document-download-refusals.json` (id
