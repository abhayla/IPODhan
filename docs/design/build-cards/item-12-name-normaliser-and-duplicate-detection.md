...
36 rule(s) from `docs/design/rules.json`, generated by
...
| §2.3.3.1 | R-177, R-218 |
| §2.3.3.2 | R-041, R-042, R-043, R-044, R-045, R-046, R-047, R-048, R-170, R-191, R-193, R-194, R-195, R-196, R-197, R-206, R-214, R-217, R-219, R-220, R-221, R-222, R-223 |
| §2.3.4 | R-053 |
