...
**Option 1: Use IPODhan Official Bot (@AbhayApps_bot)**

1. **Start Chat with Bot**:
   ```
   1. Open Telegram
   2. Search for @AbhayApps_bot
   3. Click "Start" or send /start command
   4. Bot Token: 8325511639:AAFqQtF-Jp41RAG_9kR411Ig8WuAEJ0LXWw
   ```

2. **Get Your Chat ID**:
   ```
   1. Send any message to @AbhayApps_bot
   2. Visit: https://api.telegram.org/bot8325511639:AAFqQtF-Jp41RAG_9kR411Ig8WuAEJ0LXWw/getUpdates
   3. Find "chat":{"id":12345678} in response
   4. Use this ID in admin settings
   ```
...
# Telegram (Example with IPODhan bot)
...
const config = {
  ...
  telegram: {
    enabled: true,
    botToken: "8325511639:AAFqQtF-Jp41RAG_9kR411Ig8WuAEJ0LXWw",
...
1. **Invalid Bot Token**:
   ...
   - For @AbhayApps_bot: Use `8325511639:AAFqQtF-Jp41RAG_9kR411Ig8WuAEJ0LXWw`
   - Get new token from @BotFather if creating custom bot
...
4. **Test API Directly**:
   ```bash
   # Example with @AbhayApps_bot
   curl -X POST "https://api.telegram.org/bot8325511639:AAFqQtF-Jp41RAG_9kR411Ig8WuAEJ0LXWw/sendMessage" \
