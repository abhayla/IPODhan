...
export const ScrapedIPOSchema = z.object({
  ...
  // stops validating.
  status: z.enum(['UPCOMING', 'OPEN', 'CLOSED', 'LISTED', 'WITHDRAWN', 'POSTPONED', 'DELISTED'], {
    message: 'Invalid IPO status - must be UPCOMING, OPEN, CLOSED, LISTED, WITHDRAWN, POSTPONED or DELISTED'
  }),
...
export const IPOAlertsAPIIPOSchema = z.object({
  ...
  status: z.enum(['OPEN', 'UPCOMING', 'CLOSED', 'LISTED', 'WITHDRAWN', 'POSTPONED', 'DELISTED'], {
