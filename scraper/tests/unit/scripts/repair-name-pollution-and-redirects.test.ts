...
/**
 * T-493 (#386 batch 2): repair-name-pollution-and-redirects.ts previously had NO shared prod guard — it
...
describe('repair-name-pollution-and-redirects.ts — prod-write refusal via openRepairDb()', () => {
  it('refuses --apply against current_database()="ipodhan" without --allow-prod', async () => {
    ...
    expect(refusedReason).toMatch(/repair-name-pollution-and-redirects/);
