...
# A pre-push hook exports GIT_DIR (from a linked worktree: .git/worktrees/<name>);
# drop git's repo-local variables so fixture git never hits the real repo (#1037).
for _v in ("GIT_ALTERNATE_OBJECT_DIRECTORIES GIT_CONFIG GIT_CONFIG_PARAMETERS GIT_CONFIG_COUNT "
