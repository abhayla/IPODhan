---
name: repository-caching-expert
description: Repository pattern with cache-aside implementation, BaseRepository extension, Redis strategies, TTL management, and invalidation patterns
---
