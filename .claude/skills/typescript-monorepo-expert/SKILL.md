---
name: typescript-monorepo-expert
description: TypeScript workspace management, project references, dependency configuration, and build optimization for monorepo structure
---
