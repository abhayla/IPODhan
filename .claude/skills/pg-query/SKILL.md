...
```bash
# Format
DATABASE_URL="postgresql://user:password@host:port/dbname"  # secret-scan:allow (placeholder)

# Examples
DATABASE_URL="postgresql://readonly:secret@localhost:5432/myapp_dev"  # secret-scan:allow (placeholder)
DATABASE_URL="postgresql://readonly:secret@db.example.com:5432/myapp_staging?sslmode=require"  # secret-scan:allow (placeholder)
```
