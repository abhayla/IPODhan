...
export type IPODemandGraph = InferSelectModel<typeof ipoDemandGraph>;
export type IPODemandGraphInsert = InferInsertModel<typeof ipoDemandGraph>;
 ...
 * Phase 3B: Added ipoDemandGraph for DemandGraph component
 */
