/**
 * SME Prospectus Service
 *
 * Service layer for fetching SME IPO prospectus documents (DRHP and RHP).
...
/**
 * Fetch SME IPO prospectus documents with filtering and pagination
 *
...
export async function getSMEProspectusDocuments(
  ...
  try {
    ...
    const ipoMap = new Map<string, SMEProspectusData>();
    ...
    console.error('Error fetching SME prospectus documents:', error);
