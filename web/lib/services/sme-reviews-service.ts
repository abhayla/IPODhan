/**
 * SME IPO Reviews Service
 *
 * Service layer for fetching and filtering SME IPO reviews data.
...
/**
 * Get SME IPO Reviews with filtering, pagination, and sorting
 *
...
export async function getSMEIPOReviews(
  ...
  try {
    ...
    console.error('Error fetching SME IPO reviews:', error);
    throw new Error('Failed to fetch SME IPO reviews');
  }
}
