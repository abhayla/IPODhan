        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <h3 className="text-sm font-medium text-yellow-800">
              Legacy Admin Interface - Migration Notice
            </h3>
            <div className="mt-2 text-sm text-yellow-700">
              <p className="mb-2">
                This interface is being phased out. For the latest features and complete field access, please use the{' '}
                <Link
              ...
              <div className="mt-3">
                <p className="font-medium mb-1">Benefits of Dynamic Admin:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>100% field coverage (450+ database fields vs 90 fields here)</li>
                  <li>Field protection system with auto-protect on scraper updates</li>
                  <li>DRHP extraction viewer with one-click copy</li>
                  <li>Auto-updates when database schema changes</li>
                  <li>Better navigation with IPO context banner and breadcrumbs</li>
                </ul>
              </div>
              <div className="mt-4">
                <Link
