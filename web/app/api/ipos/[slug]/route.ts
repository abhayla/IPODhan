...
export async function GET(
  ...
  try {
    ...
    const { financialData: _, documents: __, subscriptions: ___, gmpRecords: ____, listingPerformance: _____, peerCompanies: ______, registrarRelation, ipoScore: _______, ...ipoData } = ipoWithRelations;
