...
import { getMainboardIPOReviews } from '@/lib/services/mainboard-reviews-service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getMainboardIPOReviews(year, {
      reviewTitle,
      author,
      recommendation,
      ipoName,
    ...
    console.error('API Error - Mainboard Reviews:', error);
