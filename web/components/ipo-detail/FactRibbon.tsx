...
export interface RibbonCell {
  ...
  // OD-61 (owner, 2026-09-18): there is deliberately NO `disputed` prop.
  // T-328 added one, and this component rendered an "Under verification"
  // marker from it — that was a reader seeing a cross-source disagreement,
  // which OD-61 forbids outright ("keep everything admin only... no user
  // should see any disagreement"). Disputes live on /admin/conflicts.
  // Re-adding a dispute signal here needs an owner decision, not a PR.
}
