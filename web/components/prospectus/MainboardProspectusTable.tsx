 ...
 *
 * Table component for displaying Mainboard IPO prospectus documents with:
...
interface MainboardProspectusTableProps {
  prospectusData: MainboardProspectusData[];
  loading?: boolean;
  error?: string | null;
  total: number;
  page: number;
...
export function MainboardProspectusTable({
  prospectusData,
  loading = false,
  error = null,
  total,
  ...
  if (prospectusData.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        <p>No Mainboard prospectus documents available</p>
