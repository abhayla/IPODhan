/**
 * SME Content Sections Component
 *
 * Displays 6 content sections for SME IPOs landing page:
 ...
 * SME Content Sections Component
 */
export function SMEContentSections({
  currentIPOs,
  upcomingIPOs,
  recentlyListedIPOs,
  reviews,
  performanceHighlights,
  subscriptionStatus,
}: SMEContentSectionsProps) {
  return (
    <div className="space-y-12">
      {/* Section 1: Current IPOs */}
      <section>
        <SectionHeader title="Current IPOs" viewAllHref="/sme-ipos?filter=current" />
        {currentIPOs.length === 0 ? (
          <EmptyState message="No current SME IPOs" />
        ) : (
      ...
      <section>
        <SectionHeader title="Upcoming IPOs" viewAllHref="/sme-ipos?filter=upcoming" />
        {upcomingIPOs.length === 0 ? (
          <EmptyState message="No upcoming SME IPOs" />
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <section>
        <SectionHeader title="Recently Listed IPOs" viewAllHref="/sme-ipos?filter=listed" />
        {recentlyListedIPOs.length === 0 ? (
          <EmptyState message="No recently listed SME IPOs" />
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {recentlyListedIPOs.slice(0, 6).map((ipo) => {
              // Mock current price calculation for display
              const issuePrice = ipo.priceRangeMax || 0;
              const mockCurrentPrice = issuePrice * (1 + (Math.random() - 0.2) * 0.6);
      ...
      {/* Section 4: Reviews */}
      <section>
        <SectionHeader title="IPO Reviews & Analysis" viewAllHref="/sme-ipo-reviews" />
        {reviews.length === 0 ? (
          <EmptyState message="No SME IPO reviews available" />
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <section>
        <SectionHeader title="Performance Highlights" viewAllHref="/sme-ipo-performance-tracker" />
      ...
      <section>
        <SectionHeader title="Subscription Status" viewAllHref="/sme-ipos?filter=current" />
