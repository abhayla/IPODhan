...
import { Share, Clipboard, Check } from 'lucide-react';
 ...
 * Includes WhatsApp, Twitter, and Clipboard Link buttons
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {hasNativeShare ? (
        ...
        >
          <Share className="mr-2 h-4 w-4 transition-transform duration-300 group-hover:rotate-12" />
          Share
        </Button>
      ) : (
        <>
      ...
      >
        {copied ? (
          ...
          <>
            <Clipboard className="mr-2 h-4 w-4 transition-transform duration-300 group-hover:scale-110" />
            Clipboard Link
          </>
        )}
      </Button>
