 ...
 * was called (#640 round 1 review: a test importing a module that builds its
 * pool at load time saw a message claiming "are set" while neither was).
 */
function describeHostPasswordState(env: NodeJS.ProcessEnv): string {
  const present = [
