...
class TestDataNormalizer:
    ...
    def test_standardize_company_name(self):
        ...
        assert (
            self.normalizer._standardize_company_name("Test Company Limited")
            == "Test Company"
        )
    ...
    def test_normalize_amount_with_lakhs(self):
        ...
        assert (
            self.normalizer._normalize_amount("100 lakhs") == 1.0
        )  # 100 lakhs = 1 crore
    ...
    def test_calculate_derived_fields(self):
        ...
        data = {"price_band_low": 100, "price_band_high": 110, "lot_size": 150}
