...
class DataNormalizer:
    ...
    def __init__(self):
        ...
        self.company_suffixes = [
            ...
            'Private', 'Pvt', 'Pvt.', 'Public Limited Company', 'PLC'
        ]
    ...
    def normalize_ipo_data(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'company_name' in normalized:
                normalized['company_name'] = self._standardize_company_name(normalized['company_name'])
            ...
            price_fields = ['price_band_low', 'price_band_high', 'cut_off_price', 'face_value']
            ...
            logger.debug(f"Normalized data for company: {normalized.get('company_name')}")
            return normalized
    ...
    def normalize_gmp_data(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'gmp_amount' in normalized:
                normalized['gmp_amount'] = self._normalize_price(normalized['gmp_amount'])

            if 'expected_listing_price' in normalized and normalized['expected_listing_price']:
                normalized['expected_listing_price'] = self._normalize_price(normalized['expected_listing_price'])

            if 'kostak_rate' in normalized and normalized['kostak_rate']:
                normalized['kostak_rate'] = self._normalize_price(normalized['kostak_rate'])

            if 'subject_to_sauda' in normalized and normalized['subject_to_sauda']:
                normalized['subject_to_sauda'] = self._normalize_price(normalized['subject_to_sauda'])

            # Normalize GMP percentage
            if 'gmp_percentage' in normalized:
                normalized['gmp_percentage'] = self._normalize_percentage(normalized['gmp_percentage'])
    ...
    def _normalize_dates(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        date_fields = [
            ...
            'basis_of_allotment_date', 'initiation_of_refunds_date', 'credit_of_shares_date'
        ]
    ...
    def _normalize_text_fields(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        text_fields = [
            'company_name', 'symbol', 'registrar', 'exchange',
            'company_description', 'registrar_link'
        ]
